    ...
    useEffect(() => {
        const handleKeyDown = (e) => {
            if (e.ctrlKey && e.key === 'f') {
                ...
                document.querySelector('.find-replace-container input').focus();  // Focus the find input
            }
        };
    ...
    return (
        <div className="app-container"> 
            ...
            <main className="app-content">
                ...
                <button onClick={handleUpload}>Upload</button> {/* Find & Replace */}
                <FindReplace transcription={transcription} setTranscription={setTranscription} />
